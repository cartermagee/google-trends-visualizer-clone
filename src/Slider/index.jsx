...
export default class Slider extends React.Component {
  ...
  componentDidMount() {
    console.warn("slider did mount this.props= ", this.props);
  ...
  componentWillUnmount() {
    console.warn("slider unmount this.node= ", this.node);
    if (this.node) {
  ...
  componentWillReceiveProps(newProps) {
    console.warn("slider componentWillReceiveProps newProps= ", newProps);
